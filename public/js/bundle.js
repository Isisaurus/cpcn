...
var createEvent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(title, startsAt, endsAt, location, locationUrl, description) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 201) {
              ...
              (0, _alert.showAlert)('success', 'Event added successfully!');
            }
  ...
  return function createEvent(_x, _x2, _x3, _x4, _x5, _x6) {
...
var deleteEvent = /*#__PURE__*/function () {
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              ...
              (0, _alert.showAlert)('success', 'Event deleted successfully!');
            }
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error deleting Event! Try again!');
  ...
  return function deleteEvent(_x7) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteEvent = deleteEvent;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"news.js":[function(require,module,exports) {
"use strict";
...
var createNews = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(header, date, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.status === 201) {
              ...
              (0, _alert.showAlert)('success', 'News added successfully!');
            }
  ...
  return function createNews(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status === 204) {
              ...
              (0, _alert.showAlert)('success', 'News deleted successfully!');
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)('error', 'Error deleting News! Try again!');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"join.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addOverview = exports.join = exports.addFormMarkup = exports.returnDogArr = exports.returnFamilyArr = exports.returnFamMemInputs = exports.returnDogMemInputs = void 0;
...
var returnDogMemInputs = function returnDogMemInputs(dataset) {
  var dogMember = {
    nickname: '',
    gender: '',
    dateOfBirth: '',
  ...
  dogMember.nickname = document.getElementById("nickname".concat(dataset)).value;
  dogMember.dateOfBirth = document.getElementById("dogdob".concat(dataset)).value;
  dogMember.familyTree = document.getElementById("familytree".concat(dataset)).value;
  dogMember.familyTreeNumber = document.getElementById("number".concat(dataset)).value;
  var female = document.getElementById("female".concat(dataset));
  var male = document.getElementById("male".concat(dataset));
...
exports.returnDogMemInputs = returnDogMemInputs;

var returnFamMemInputs = function returnFamMemInputs(dataset) {
  var famMember = {
    firstName: '',
    lastName: '',
    dateOfBirth: ''
  ...
  if (document.getElementById("familyFirstName".concat(dataset)).value) {
    famMember.firstName = document.getElementById("familyFirstName".concat(dataset)).value;
  } else {
    famMember.firstName = '';
  }

  if (document.getElementById("familyLastName".concat(dataset)).value) {
    famMember.lastName = document.getElementById("familyLastName".concat(dataset)).value;
  } else {
    famMember.lastName = '';
  }

  if (document.getElementById("familyDob".concat(dataset)).value) {
    famMember.dateOfBirth = document.getElementById("familyDob".concat(dataset)).value;
  } else {
...
exports.returnFamMemInputs = returnFamMemInputs;

var returnFamilyArr = function returnFamilyArr(family) {
  // define familyMembers array
  var familyMembers = []; // forEach family member return a familyMember object using return inputs function

  family.forEach(function (fam) {
    var famObj = returnFamMemInputs(fam.dataset.set);
    familyMembers.push(famObj);
  });
  return familyMembers;
};

exports.returnFamilyArr = returnFamilyArr;

var returnDogArr = function returnDogArr(dogs) {
  var dogArr = [];
  dogs.forEach(function (dog) {
    var dogObj = returnDogMemInputs(dog.dataset.set);
    dogArr.push(dogObj);
  });
  return dogArr;
}; //HTML markups
...
exports.returnDogArr = returnDogArr;

var addFormMarkup = function addFormMarkup(dataset, type, parentEl) {
  var markup;

  if (type === 'dog') {
    markup = "\n    \n    <div\n      class=\"join_form__section join_form__section--2col join_form__section--dogs margin-top-medium\" data-set=\"".concat(dataset, "\" \n    >\n      <div class=\"join_form__group\">\n        <label for=\"nickname").concat(dataset, "\" class=\"join_form__label\"\n          >Roepnaam*</label\n        >\n        <input\n          type=\"text\"\n          id=\"nickname").concat(dataset, "\"\n          class=\"join_form__input\"\n          name=\"nickname").concat(dataset, "\"\n        />\n      </div>\n      <div class=\"join_form__gender\">\n        <div class=\"join_form__group--radio\">\n          <input\n            id=\"female").concat(dataset, "\"\n            type=\"radio\"\n            name=\"gender").concat(dataset, "\"\n            value=\"female\"\n            checked\n          />\n          <label for=\"female").concat(dataset, "\" class=\"join_form__label\">teef</label>\n        </div>\n        <div class=\"join_form__group--radio\">\n          <input\n            id=\"male").concat(dataset, "\"\n            type=\"radio\"\n            name=\"gender").concat(dataset, "\"\n            value=\"male\"\n          />\n          <label for=\"male").concat(dataset, "\" class=\"join_form__label\">reu</label>\n        </div>\n      </div>\n      <div class=\"join_form__group\">\n        <label for=\"dogdob").concat(dataset, "\" class=\"join_form__label\"\n          >Geboortedatum*</label\n        >\n        <input\n          type=\"date\"\n          id=\"dogdob").concat(dataset, "\"\n          class=\"join_form__input\"\n          required\n          name=\"dogdob").concat(dataset, "\"\n        />\n      </div>\n      <div class=\"join_form__group\"></div>\n      <div class=\"join_form__group\">\n        <label for=\"familytree").concat(dataset, "\" class=\"join_form__label\"\n          >Stamboom</label\n        >\n        <input\n          type=\"text\"\n          id=\"familytree").concat(dataset, "\"\n          class=\"join_form__input\"\n          name=\"familytree").concat(dataset, "\"\n        />\n      </div>\n      <div class=\"join_form__group\">\n        <label for=\"number").concat(dataset, "\" class=\"join_form__label\"\n          >Stamboom Registratie Nummer</label\n        >\n        <input\n          type=\"text\"\n          id=\"number").concat(dataset, "\"\n          class=\"join_form__input\"\n          name=\"number").concat(dataset, "\"\n        />\n      </div>\n    </div>\n\n  ");
  } else if (type === 'family') {
    markup = "\n    <div class=\"join_form__section join_form__section--2col margin-top-medium join_form__section--fam\" data-set=\"".concat(dataset, "\">\n    <div class=\"join_form__group\">\n        <label for=\"familyFirstName").concat(dataset, "\" class=\"join_form__label\"\n        >Voornaam*</label\n        >\n        <input\n        type=\"text\"\n        name=\"familyFirstName\"\n        id=\"familyFirstName").concat(dataset, "\"\n        class=\"join_form__input\"\n        required\n        />\n    </div>\n    <div class=\"join_form__group\">\n        <label for=\"familyLastName").concat(dataset, "\" class=\"join_form__label\"\n        >Achternaam*</label\n        >\n        <input\n        type=\"text\"\n        name=\"familyLastName\"\n        id=\"familyLastName").concat(dataset, "\"\n        class=\"join_form__input\"\n        required\n        />\n    </div>\n    <div class=\"join_form__group\">\n        <label for=\"familyDob").concat(dataset, "\" class=\"join_form__label\"\n        >Geboortedatum*</label\n        >\n        <input\n        type=\"date\"\n        name=\"familyDob\"\n        id=\"familyDob").concat(dataset, "\"\n        class=\"join_form__input\"\n        required\n        />\n    </div>\n\n    </div>\n          ");
  }
...
exports.addFormMarkup = addFormMarkup;
var joinForm = document.getElementById('joinForm');

var join = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(memberObj) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', 'You signed up successfully! Check your email!');
              window.setTimeout(function () {
                if (joinForm) {
                  joinForm.reset();
                }
...
var overviewTableMarkup = function overviewTableMarkup(type, data) {
  var markup;

  if (type === 'dogs') {
    markup = data.map(function (dog) {
      return "\n  <tr>\n    <td class=\"table__dog_info__nickname\">".concat(dog.nickname, "</td>\n    </tr>\n  <tr class=\"table__dog_info__details_row\">  \n    <td>").concat(dog.gender, "</td>\n    <td>").concat(dog.dateOfBirth, "</td>\n    <td>").concat(dog.familyTree, "</td>\n    <td>").concat(dog.familyTreeNumber, "</td>\n  </tr>\n    ");
    });
  } else if (type === 'family') {
    if (data.length !== 0) {
      markup = data.map(function (member) {
        if (member) {
          return "\n          <tr>\n            <td>".concat(member.firstName, " ").concat(member.lastName, "</td>\n            <td>").concat(member.dateOfBirth, "</td>\n          </tr>\n        ");
        } else {
  ...
  var fullMarkup = markup.join('');
  return fullMarkup;
}; ////////////////////// add Overview Markup


var addOverview = function addOverview(parentEl, memberState) {
  // calculate member fee from database values
  var memberFee = memberState.fee + " \u20AC";
  var familyMarkups = overviewTableMarkup('family', memberState.familyMembers);
  var dogMarkups = overviewTableMarkup('dogs', memberState.dogs);
  var markup = "\n  <table class=\"table__personal_info\">\n    <tr>\n      <td>Full Name</td>\n      <td>".concat(memberState.firstName, " ").concat(memberState.lastName, "</td>\n    </tr>\n    <tr>\n      <td>Initials</td>\n      <td>").concat(memberState.initials, "</td>\n    </tr>\n    <tr>\n      <td>Date Of Birth</td>\n      <td>").concat(memberState.dateOfBirth, "</td>\n    </tr>\n    <tr>\n      <td>Phone</td>\n      <td>").concat(memberState.phone, "</td>\n    </tr>\n    <tr>\n      <td>Email</td>\n      <td>").concat(memberState.email, "</td>\n    </tr>\n    <tr>\n      <td>Address</td>\n      <td>").concat(memberState.address.country, ", ").concat(memberState.address.postcode, ", ").concat(memberState.address.city, ", ").concat(memberState.address.street, "</td>\n    </tr>\n  </table>\n  <table class=\"table__family_info\">\n    <tr class=\"table__header\">\n      <td class=\"header__tertiary\">Family Members</td>\n    </tr>\n    ").concat(familyMarkups, "\n  </table>\n  <table class=\"table__dog_info\">\n    <tr class=\"table__header\">\n      <td class=\"header__tertiary\">dogs</td>\n    </tr>\n    ").concat(dogMarkups, "\n  </table>\n  <table class=\"table__membership_fee\">\n    <td>Membership Fee</td>\n    <td>").concat(memberFee, "</td>\n  </table>\n  ");
  parentEl.innerHTML = markup;
};

exports.addOverview = addOverview;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"membership.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.calculateFees = exports.updateFees = void 0;
...
var updateFees = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(feeObj, feeId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'post',
              url: "/api/v1/membership/".concat(feeId),
              data: _objectSpread({}, feeObj)
            });
          ...
          case 3:
            ...
            if (res.status === 200) {
              ...
              (0, _alert.showAlert)('success', 'Membership fee updated successfully!');
            }
  ...
  return function updateFees(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var calculateFees = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(memberObj) {
    var res, feeObj, regDate, halffeeDate, fees, above12, under12, numDogs, memberFee, registrationFee, dogFee, familyFee, finalFee;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 3:
            res = _context2.sent;
            feeObj = res.data.data.data[0]; // compare dates (half year fee after 1st of July)

            regDate = new Date(Date.now());
            halffeeDate = new Date("".concat(regDate.getFullYear(), "-07-01, 00:00:00")); // decide if full or half year fees apply
            ...
            if (memberObj.familyMembers) {
              memberObj.familyMembers.map(function (fam) {
                if (fam) {
                  var date = new Date("".concat(fam.dateOfBirth, " 00:00:00"));
                  var diff = (date.getTime() - regDate.getTime()) / 1000;
                  diff /= 60 * 60 * 24;
            ...
            numDogs = memberObj.dogs.length;
            memberFee = fees.membership * 1;
            registrationFee = fees.registration * 1;
            dogFee = numDogs > 3 ? fees.dog * (numDogs - 3) : 0;
            familyFee = fees.under12 * under12 + fees.family * above12; // return full fee

            finalFee = memberFee + registrationFee + dogFee + familyFee; // console.log(finalFee);

            return _context2.abrupt("return", finalFee);

          case 20:
            _context2.prev = 20;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)('error', "Error calculating membership fee.");
  ...
  return function calculateFees(_x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.calculateFees = calculateFees;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updatePw.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updatePw = void 0;
...
var updatePw = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(passwordCurrent, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Password successfully changed.');
              window.setTimeout(function () {
                location.assign('/administration');
              }, 1500);
            }
  ...
  return function updatePw(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.updatePw = updatePw;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"footerMessage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendFooterMessage = void 0;
...
var footerSendForm = document.getElementById('contact_form');

var sendFooterMessage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', 'Thank you for your message! We will get back to you soon!');
              window.setTimeout(function () {
                if (footerSendForm) {
  ...
  return function sendFooterMessage(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.sendFooterMessage = sendFooterMessage;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"uploadGalleryImage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uploadGalleryImage = void 0;
...
var uploadGalleryImage = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Image uploaded successfully!');
              window.setTimeout(function () {
                location.assign('/administration');
              }, 2000);
            }
  ...
  return function uploadGalleryImage(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.uploadGalleryImage = uploadGalleryImage;
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"galley.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showImg = exports.insertGalleryImages = void 0;
...
var splitArr = function splitArr(arr) {
  var parts = [];
  var i = 0;
...
var insertGalleryImages = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(parentEl) {
    var markup, data, dataArr, markupGroups, _dataArr, _markupGroups;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return fetch('./../img/gallery/image_titles.json').then(function (res) {
              return res.json();
            });
          ...
          case 4:
            ...
            if (Object.keys(data).length < 4) {
              Object.values(data).map(function (src) {
                var singleMarkup = "\n        <div class=\"col-1\">\n            <div class=\"gallery__img\" background-image=\"/img/gallery/".concat(Object.values(src)[0], "\"></div>\n        </div>\n            "); // markup.concat(' ', singleMarkup);

                markup = markup.concat('', singleMarkup);
              });
            } else if (Object.keys(data).length % 4 === 0) {
              dataArr = Object.values(data);
              markupGroups = splitArr(dataArr);
              markupGroups.forEach(function (group, i) {
                if (+i % 2 === 0) {
                  var rowLeftMarkup = "\n            <div class=\"col-1\">\n                <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/".concat(group[0].src, ")\"></div>\n            </div>\n            <div class=\"col-2\">\n                <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[1].src, ")\"></div>\n                <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[2].src, ")\"></div>\n                <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[3].src, ")\"></div>\n            </div>\n          ");
              ...
              _dataArr = Object.values(data);
              _markupGroups = splitArr(_dataArr);

              _markupGroups.forEach(function (group, i) {
                if (group.length === 4) {
                  if (+i % 2 === 0) {
                    var rowLeftMarkup = "\n                  <div class=\"col-1\">\n                      <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/".concat(group[0].src, ")\"></div>\n                  </div>\n                  <div class=\"col-2\">\n                      <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[1].src, ")\"></div>\n                      <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[2].src, ")\"></div>\n                      <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/").concat(group[3].src, ")\"></div>\n                  </div>\n                ");
                    markup = markup.concat('', rowLeftMarkup);
                  ...
                  group.forEach(function (obj, i) {
                    var singleRowMarkup = "\n                <div class=\"col-1\">\n                    <div class=\"gallery__img\" style=\"background-image: url(./../img/gallery/".concat(group[i].src, ")\"></div>\n                </div>\n            ");
...
var showImg = function showImg(imgDiv, galleryContainer, imgDivArr) {
  ...
  var nextBtn = document.querySelector('.modal__btn--next');
  var prevBtn = document.querySelector('.modal__btn--prev');
  var next = 0;

  var following = function following() {
    next++;
    var nextDataset = "".concat(+dataset + next);
    var nextImgMarkup = '';

    if (nextDataset <= imgDivArr.length) {
      var nextImgSrc = document.querySelector("[data-img=\"".concat(nextDataset, "\"]")).style.backgroundImage.slice(9, 46);
      nextImgMarkup = "\n        <img id=\"cur_img\" class=\"modal__pic\" src=\"".concat(nextImgSrc, "\" data-pic=\"").concat(nextDataset, "\"/>\n      ");
  ...
  var previous = function previous() {
    var prevImgMarkup = '';
    var curDataset = document.getElementById('cur_img').dataset.pic;
    var prevDataset = +curDataset - 1;

    if (prevDataset > 0) {
      var prevImgSrc = document.querySelector("[data-img=\"".concat(prevDataset, "\"]")).style.backgroundImage.slice(9, 46);
      prevImgMarkup = "\n        <img id=\"cur_img\" class=\"modal__pic\" src=\"".concat(prevImgSrc, "\" data-pic=\"").concat(prevDataset, "\"/>\n      ");
      document.querySelector('.modal__img').innerHTML = '';
  ...
  if (modalWindow) {
    ...
    modalWindow.addEventListener('click', function (e) {
      var isModalClose = e.target.classList.contains('modal__close');
...
var _updatePw = require("./updatePw");

var _footerMessage = require("./footerMessage");

var _uploadGalleryImage = require("./uploadGalleryImage");

var _galley = require("./galley");

var body = document.querySelector('body');
var loginForm = document.getElementById('form_login');
var logoutBtn = document.querySelector('#logout');
var logoutBtn2 = document.querySelector('#logout2');
var nav = document.querySelector('.nav');
var sideNav = document.querySelector('.side_nav');
var sideNavList = document.querySelector('.side_nav__list');
var burger = document.getElementById('burger');
var questions = document.querySelectorAll('.section__qa__question');
var tabContainer = document.querySelector('.section_content__tabs');
var tabs = document.querySelectorAll('.section_content__button');
var tabsContent = document.querySelectorAll('.section_content__content');
var newsForm = document.getElementById('newsForm');
var newsFormDelete = document.getElementById('newsFormDelete');
var eventsForm = document.getElementById('eventsForm');
var eventsFormDelete = document.getElementById('eventsFormDelete');
var tabsContainerAdmin = document.getElementById('admin_menu');
var tabsAdmin = document.querySelectorAll('.admin_nav__el');
var tabsContentAdmin = document.querySelectorAll('.admin_view');
var removeFameMemBtn = document.getElementById('removeFamMem');
var addFamMemBtn = document.getElementById('addFamMem');
var addFamMemContainer = document.getElementById('addFamMemContainer');
var removeDogBtn = document.getElementById('removeDog');
var addDogBtn = document.getElementById('addDog');
var addDogContainer = document.getElementById('addDogContainer');
var showOverviewModalBtn = document.getElementById('showOverviewModalBtn');
var overviewModal = document.getElementById('showOverviewModal');
var submitJoinFormBtn = document.getElementById('submitJoinFormBtn');
var showOverViewContainer = document.getElementById('showOverViewContainer');
var overviewCotnainer = document.getElementById('showOverview');
var closeModalBtn = document.getElementById('closeModalBtn');
var modalOverlay = document.getElementById('modalOverlay');
var cancelJoinFormBtn = document.getElementById('cancelJoinForm');
var updateFeeBtn = document.getElementById('updatefee');
var updatePwForm = document.getElementById('profile_password');
var footerSendForm = document.getElementById('contact_form');
var galleryForm = document.getElementById('upload_image');
var galleryContainer = document.getElementById('gallery');
var col1ImgContainers = document.querySelectorAll('.col-1');
var memberState; ///////////////////////// showmodal
...
var hideSideNav = function hideSideNav() {
...
var showSideNav = function showSideNav() {
...
var sideNavToggle = function sideNavToggle() {
...
var toggleQuestion = function toggleQuestion(e) {
  var paragraph = e.currentTarget.parentElement.querySelector('.section__qa__answer');
  var svgUse = e.currentTarget.querySelector('svg').querySelector('use');
...
if (logoutBtn2) {
  logoutBtn2.addEventListener('click', _login.logout);
} // burger menu
...
if (tabContainer) {
  tabContainer.addEventListener('click', function (e) {
    var clicked = e.target.closest('.section_content__button');
    if (!clicked) return;
    ...
    var content = document.querySelector(".section_content__content--".concat(clicked.dataset.tab));
...
if (addFamMemBtn) {
  addFamMemBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var maxFamMem = 4;

    if (addFamMemContainer.children.length <= maxFamMem) {
      (0, _join.addFormMarkup)(addFamMemContainer.children.length, 'family', addFamMemContainer);
      removeFameMemBtn.classList.remove('hid');
    } else {
      (0, _alert.showAlert)('error', "You can only add max. ".concat(maxFamMem + 1, " family members!"));
    }
  });
...
if (removeFameMemBtn) {
  removeFameMemBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (addDogContainer) {
  addDogBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var maxDogs = 4;

    if (addDogContainer.children.length <= maxDogs) {
      (0, _join.addFormMarkup)(addDogContainer.children.length, 'dog', addDogContainer);
      removeDogBtn.classList.remove('hid');
    } else {
      (0, _alert.showAlert)('error', "You can only add max. ".concat(maxDogs + 1, " dogs!"));
    }
  });
} // remove dog
...
if (removeDogBtn) {
  removeDogBtn.addEventListener('click', function (e) {
    e.preventDefault();
...
if (addFamMemContainer) {
  memberState = {};
  showOverviewModalBtn.addEventListener('click', function () {
    var famMems = document.querySelectorAll('.join_form__section--fam');
    var dogs = document.querySelectorAll('.join_form__section--dogs');
    ...
    var country = document.getElementById('memberCountry').value;
    var city = document.getElementById('memberCity').value;
    var street = document.getElementById('memberAddress').value;
    ...
    var famArray = (0, _join.returnFamilyArr)(famMems);
    var dogArray = (0, _join.returnDogArr)(dogs);
    memberState = {
      firstName: firstName,
      lastName: lastName,
      initials: initials,
...
if (showOverviewModalBtn) {
  showOverviewModalBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var formValid = document.forms['joinForm'].reportValidity(); // TEST
    // const formValid = true;

    if (formValid) {
      (0, _membership.calculateFees)(memberState).then(function (fee) {
        memberState.fee = fee;
        return memberState;
      }).then(function (memberState) {
        showModal();
        (0, _join.addOverview)(showOverview, memberState);
      });
    }
  });
}
...
if (submitJoinFormBtn) {
  submitJoinFormBtn.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _join.join)(memberState);
  });
}
...
if (cancelJoinFormBtn) {
  cancelJoinFormBtn.addEventListener('click', function (e) {
    e.preventDefault();
    hideModal();
  });
}
...
if (newsForm) {
  newsForm.addEventListener('submit', function (e) {
    ...
    (0, _news.createNews)(header, date, description);
  });
}
...
if (newsFormDelete) {
  newsFormDelete.addEventListener('submit', function (e) {
    e.preventDefault();
    var deleteNewsInputs = document.querySelectorAll('.deleteNews__input');
    var id = null;
    deleteNewsInputs.forEach(function (el) {
      if (el.checked) {
        id = el.value;
      }
    });
    (0, _news.deleteNews)(id);
  });
}
...
if (eventsForm) {
  eventsForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var sdate = document.getElementById('endsAtDate').value;
    var stime = document.getElementById('endsAtTime').value;
    var edate = document.getElementById('endsAtDate').value;
    var etime = document.getElementById('endsAtTime').value;
    var title = document.getElementById('event_title').value;
    var location = document.getElementById('event_location').value;
    var locationUrl = document.getElementById('event_locationUrl').value;
    var description = document.getElementById('event_description').value;
    var startsAt = "".concat(sdate, " ").concat(stime);
    var endsAt = "".concat(edate, " ").concat(etime);
    (0, _events.createEvent)(title, startsAt, endsAt, location, locationUrl, description);
  });
}
...
if (eventsFormDelete) {
  eventsFormDelete.addEventListener('submit', function (e) {
    e.preventDefault();
    var deleteEventInput = document.querySelectorAll('.deleteEvents__input');
    var id = null;
    deleteEventInput.forEach(function (el) {
      if (el.checked) {
        id = el.value;
      }
    });
    (0, _events.deleteEvent)(id);
  });
} // CMS - TABS


if (tabsContainerAdmin) {
  tabsContainerAdmin.addEventListener('click', function (e) {
    var clicked = e.target.closest('.admin_nav__el');
    if (!clicked) return;
    tabsAdmin.forEach(function (btn) {
      btn.classList.remove('admin_nav__el--active');
    });
    clicked.classList.add('admin_nav__el--active');
    tabsContentAdmin.forEach(function (cont) {
      cont.classList.remove('admin_view--active');
    });
    var content = document.querySelector(".admin_view--".concat(clicked.dataset.tab));
    if (!content) return;
...
if (updateFeeBtn) {
  updateFeeBtn.addEventListener('click', function (e) {
    e.preventDefault(); // inputs

    var feeMember = document.getElementById('fee_member').value;
    var feeFamily = document.getElementById('fee_family').value;
    var feeDog = document.getElementById('fee_dog').value;
    var feeReg = document.getElementById('fee_reg').value;
    var feeUnder12 = document.getElementById('fee_under12').value;
    var halffeeMember = document.getElementById('halffee_member').value;
    var halffeeFamily = document.getElementById('halffee_family').value;
    var halffeeDog = document.getElementById('halffee_dog').value;
    var halffeeReg = document.getElementById('halffee_reg').value;
    var halffeeUnder12 = document.getElementById('halffee_under12').value; // data obj
    ...
    var feeId = document.getElementById('membershipform').dataset.set;
    (0, _membership.updateFees)(feeObj, feeId);
  });
} // update pw using API
...
if (updatePwForm) {
  updatePwForm.addEventListener('submit', function (e) {
    ...
    var passwordCurrent = document.getElementById('user_password_current').value;
    var password = document.getElementById('user_password').value;
    var passwordConfirm = document.getElementById('user_password_confirm').value;
    (0, _updatePw.updatePw)(passwordCurrent, password, passwordConfirm);
  });
} /// footer message
...
if (footerSendForm) {
  footerSendForm.addEventListener('submit', function (e) {
    e.preventDefault(); // console.log('Sending contact event listener!');
    ...
    (0, _footerMessage.sendFooterMessage)(senderState);
  });
} // gallery form
...
if (galleryForm) {
  galleryForm.addEventListener('submit', function (e) {
    ...
    form.append('image', document.getElementById('upload_image_input').files[0]);
    (0, _uploadGalleryImage.uploadGalleryImage)(form);
  });
} // gallery


if (galleryContainer) {
  (0, _galley.insertGalleryImages)(galleryContainer);
}
